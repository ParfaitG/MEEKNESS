...
class GUIapp():
    ...
    def __init__(self):
        self.root = Tk()
        self.dbConnect(orig='Girl, Monsieur Verdoux')
        self.buildControls()
        self.populateData()
        self.root.mainloop()
    ...
    def dbConnect(self, orig):
        ...
        # DB CONNECT
        self.db = sqlite3.connect('/path/to/Meekness.db')
	...
	# DATABASE IMAGE
        self.dbimglbl = Label(self.guiframe, text='           SQLite', font=("Arial", 14)).\
                         grid(row=0, column=0, sticky=W, padx=5, pady=5)

        self.dbimg_obj = Image.open('SQLite.jpg')
