...
class GUIapp():
    ...
    def __init__(self):
        self.root = Tk()
        self.dbConnect(orig='Chris Adams')
        self.buildControls()
        self.populateData()
        self.root.mainloop()
    ...
    def dbConnect(self, orig):
        ...
        # DB CONNECT
        self.db = cx_Oracle.connect('***/***@*****:1521/xe')            
	...
	# DATABASE IMAGE
        self.dbimglbl = Label(self.guiframe, text='                Oracle', font=("Arial", 14)).\
                         grid(row=0, column=0, sticky=W, padx=5, pady=5)

        self.dbimg_obj = Image.open('Oracle.jpg')
