...
public class SQLite_Swing extends Frame implements WindowListener {
   ...
   public static Connection dbConn() {
      ...
      try {
          String database = "/path/to/Meekness.db"; 
   ...
   public SQLite_Swing(ArrayList<String> char_list) throws IOException, SQLException {
      ...
      // DB IMAGE      
      ImageIcon dbimgIcon = new ImageIcon("SQLite.jpg");
      ...
      JLabel dbimglbl = new JLabel("               SQLite", SwingConstants.LEFT);      
