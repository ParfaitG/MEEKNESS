...
public class MySQL_Swing extends Frame implements WindowListener {
   ...
   public static Connection dbConn() {
      ...
      try {
	  String url = "jdbc:mysql://*****:3306/***?autoReconnect=true&useSSL=false";            
          String username = "***";
          String password  = "***";
   ...
   public static void runData(String charPick, JPanel guipanel, GridBagConstraints c) throws IOException, SQLException {
      ...
      charpic_list = get_CharData(conn, "SELECT c.`Character`, c.Picture, c.Description FROM Characters c " +
   ...
   public MySQL_Swing(ArrayList<String> char_list) throws IOException, SQLException {
      ...
      // DB IMAGE      
      ImageIcon dbimgIcon = new ImageIcon("MySQL.jpg");
      ...
      JLabel dbimglbl = new JLabel("               MySQL", SwingConstants.LEFT);      
