...
public class Postgres_Swing extends Frame implements WindowListener {
   ...
   public static Connection dbConn() {
      ...
      try {
	  String url = "jdbc:postgresql://*****:5432/***?user=meekdba&password=poet17&ssl=false";            
          String username = "***";
          String password  = "***";
   ...
   public static List<Object> get_CharData(Connection conn, String strSQL, String param){
   ...
   public static void runData(String charPick, JPanel guipanel, GridBagConstraints c) throws IOException, SQLException {
      ...
      charpic_list = get_CharData(conn, "SELECT c.Character, c.Picture, c.Description " +
                                       "FROM Characters c WHERE c.Character = ?", charPick);
      ...
      Image newimg = image.getScaledInstance(387, 250,  java.awt.Image.SCALE_SMOOTH);
   ...
   public Postgres_Swing(ArrayList<String> char_list) throws IOException, SQLException {
      ...
      // DB IMAGE      
      ImageIcon dbimgIcon = new ImageIcon("Postgres.jpg");
      ...
      JLabel dbimglbl = new JLabel("               PostgreSQL", SwingConstants.LEFT);      
