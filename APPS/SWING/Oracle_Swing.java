...
public class Oracle_Swing extends Frame implements WindowListener {
   ...
   public static ArrayList<String> get_Data(Connection conn, String strSQL, Object param){
   ...
   public static void runData(String charPick, JPanel guipanel, GridBagConstraints c) throws IOException, SQLException {
      ...
      qual_list = get_Data(conn, "SELECT q.Quality FROM Qualities q " +
                                 ...
                                 "WHERE c.Character = ?", charpic_list.get(0));
      ...
      Blob blob = ((Blob)charpic_list.get(1));

      ImageIcon imgIcon = new ImageIcon(blob.getBytes(1, (int)blob.length()));
   ...
   public Oracle_Swing(ArrayList<String> char_list) throws IOException, SQLException {
      ...
      // DB IMAGE      
      ImageIcon dbimgIcon = new ImageIcon("Oracle.jpg");
      ...
      JLabel dbimglbl = new JLabel("               Oracle", SwingConstants.LEFT);      
      ...
      runData("John Coffey", guipanel, c);
