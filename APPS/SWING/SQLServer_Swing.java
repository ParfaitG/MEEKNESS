...
public class SQLServer_Swing extends Frame implements WindowListener {
   ...
   public static Connection dbConn() {
      ...
      try {
	  String url = "jdbc:sqlserver://*****:1433;databaseName=***;user=***;password=***";             
   ...
   public static void runData(String charPick, JPanel guipanel, GridBagConstraints c) throws IOException, SQLException {
      ...
      charpic_list = get_CharPic(conn, "SELECT c.[Character], c.[Description], c.[Picture] " + 
                                       " FROM Characters c " +
      ...
      InputStream blob = ((InputStream)charpic_list.get(2));
      ...
      // DESCRIPTION LABEL
      JLabel desc_lbl = new JLabel("<html><body style='width:290px'>" + charpic_list.get(1).toString(), SwingConstants.CENTER);
      ...
      // QUALITY LABELS
      int i = 5;
      for (String q: qual_list){
	JLabel qual_lbl = new JLabel(q, SwingConstants.LEFT);
   ...
   public SQLServer_Swing(ArrayList<String> char_list) throws IOException, SQLException {
      ...
      // DB IMAGE      
      ImageIcon dbimgIcon = new ImageIcon("SQLServer.jpg");
      Image dbimage = dbimgIcon.getImage();
      Image newdbimg = dbimage.getScaledInstance(75, 60,  java.awt.Image.SCALE_SMOOTH);
      ...
      JLabel dbimglbl = new JLabel("                 SQL Server", SwingConstants.LEFT);      
